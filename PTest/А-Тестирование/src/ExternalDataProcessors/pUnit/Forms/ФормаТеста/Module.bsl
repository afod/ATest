...
Процедура ЗаполнитьДеревоТестов()
	...
	ДобавитьТестВДерево(Строкараздел, "Тест: получен курс на нужную дату", "ТестПолучениеКурсаВалюты_ПроверкаДаты");
	ДобавитьТестВДерево(Строкараздел, "Тест: получено правильное значение курса", "ТестПолучениеКурсаВалюты_ПроверкаКурса");
	ДобавитьТестВДерево(Строкараздел, "Тест: получен курс правильной валюты", "ТестПолучениеКурсаВалюты_ПроверкаВалюты");
...
Процедура ТестПолучениеКурсаВалюты_ПроверкаДаты()
...
Процедура ТестПолучениеКурсаВалюты_ПроверкаКурса()
...
Процедура ТестПолучениеКурсаВалюты_ПроверкаВалюты()
